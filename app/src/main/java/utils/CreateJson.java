...
public class CreateJson {
    ...
    private JSONObject interviewtoJson() throws JSONException {
        ...
        map = QuestionModel.quest.get("f");
        if (map != null)
            for (Map.Entry<String, List<String>> entry : map.entrySet()) {
                jsonObject.put(entry.getKey(), entry.getValue());
            }

        map = QuestionModel.quest.get("g");
        if (map != null)
            for (Map.Entry<String, List<String>> entry : map.entrySet()) {
                jsonObject.put(entry.getKey(), entry.getValue());
            }

        map = QuestionModel.quest.get("h");
        if (map != null)
            for (Map.Entry<String, List<String>> entry : map.entrySet()) {
                jsonObject.put(entry.getKey(), entry.getValue());
            }

        map = QuestionModel.quest.get("i");
        if (map != null)
            for (Map.Entry<String, List<String>> entry : map.entrySet()) {
                jsonObject.put(entry.getKey(), entry.getValue());
            }

        map = QuestionModel.quest.get("ii");
        if (map != null)
            for (Map.Entry<String, List<String>> entry : map.entrySet()) {
                jsonObject.put(entry.getKey(), entry.getValue());
            }

        map = QuestionModel.quest.get("j");
        if (map != null)
            for (Map.Entry<String, List<String>> entry : map.entrySet()) {
                jsonObject.put(entry.getKey(), entry.getValue());
            }

        map = QuestionModel.quest.get("k");
        if (map != null)
            for (Map.Entry<String, List<String>> entry : map.entrySet()) {
                jsonObject.put(entry.getKey(), entry.getValue());
            }

        map = QuestionModel.quest.get("l");
        if (map != null)
            for (Map.Entry<String, List<String>> entry : map.entrySet()) {
                jsonObject.put(entry.getKey(), entry.getValue());
            }

        map = QuestionModel.quest.get("ws");
        if (map != null)
            for (Map.Entry<String, List<String>> entry : map.entrySet()) {
                jsonObject.put(entry.getKey(), entry.getValue());
            }

        map = QuestionModel.quest.get("hw");
        if (map != null)
            for (Map.Entry<String, List<String>> entry : map.entrySet()) {
                jsonObject.put(entry.getKey(), entry.getValue());
            }
