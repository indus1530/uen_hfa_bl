...
public class LocalDataManager {
    ...
    public List<String> getLogList(String status) {
        ...
        try {
            ...
            String query = "select * from tbllog where Interview_status = '%s' order by id ASC";
            ...
            if (c != null) {
                if (c.moveToFirst()) {
                    do {
                        ...
                        list.add(c.getString(7) + "/" + c.getString(6));
    ...
    public void getvalidationforPending(String id) {


        try {

            String query = "select * from tbllog where hfa_id = '%s'";
            ...
            if (c != null) {
                if (c.moveToFirst()) {
                    do {
                        ...
                        Validation.F1_4_ischekd = c.getString(8);
                        Validation.F1_5_ischekd = c.getString(9);
                        Validation.F1_6_ischekd = c.getString(10);
                        Validation.F1_15_ischekd = c.getString(11);
                        Validation.A13_2_ischekd = c.getString(12);
                        Validation.A2 = c.getString(13);
                        Validation.A3 = c.getString(14);
                        Validation.HFAPK = c.getString(15);
                        Validation.A1 = c.getString(16);
                        Validation.hfauploadid = c.getString(17);
                        Validation.A4 = c.getString(18);
                        Validation.atstage = c.getString(19);
    ...
    public HashMap<String, String> getinterviewforView(String id) {
        ...
        if (c != null) {
            if (c.moveToFirst()) {
                ...
                param.put("P1_1", c.getString(749));
                param.put("H4_8", c.getString(750));
                param.put("H9_10", c.getString(751));
                param.put("user_submite_id", new MyPreferences(mContext).getUserId() + "");
                param.put("app_version", "HFA713");
            }
